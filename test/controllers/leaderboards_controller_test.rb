...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference('Leaderboard.count') do
      post leaderboards_url, params: { leaderboard: { game: @leaderboard.game, participant_id: @leaderboard.participant_id, starttijd: @leaderboard.starttijd, stoptijd: @leaderboard.stoptijd } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { game: @leaderboard.game, participant_id: @leaderboard.participant_id, starttijd: @leaderboard.starttijd, stoptijd: @leaderboard.stoptijd } }
